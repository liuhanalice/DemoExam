...
$(document).ready(function() {
    ...
    // Decrease font size
      $("#decrease-font-size").on("click", function() {
        ...
        if (currentFontSize > 1) {
          ...
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User decreased font size to ${$("#font-size-input").val()}.\n`);
        } else{
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User tried to decrease font size below minimum.\n`);
        }
    ...
    // Increase font size
      $("#increase-font-size").on("click", function() {
        ...
        if(currentFontSize <30){
          $("#font-size-input").val(currentFontSize + 1);
          $("#question-content").css("font-size", currentFontSize + 1 + "px");
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User increased font size to ${$("#font-size-input").val()}.\n`);
        } else{
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User tried to increase font size over maximum.\n`);
        }
    ...
    // Change font size
      $("#font-size-input").change(function() {
        ...
        if (currentFontSize >= 1 && currentFontSize <= 30) {
          ...
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User changed font size to ${$(this).val()}.\n`);
        } else{
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User tried to change font size to an invalid value.\n`);
        }
    ...
    // Decrease timer size
      $("#decrease-timer-size").on("click", function (){
        ...
        if(currentTimerSize > 10){
          ...
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User decreased timer size to ${$("#timer-size-input").val()}.\n`);
        } else{
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User tried to decrease timer size below minimum.\n`);
        }
    ...
    // Increase timer size
      $("#increase-timer-size").on("click", function (){
        ...
        if(currentTimerSize < 500){
          ...
          $("#timer-size-input").val(currentTimerSize + '%');
          $("#Timer").css('font-size',  20+(currentTimerSize - 100)/10);
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User increased timer size to ${$("#timer-size-input").val()}.\n`);
        } else{
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User tried to increase timer size over maximum.\n`);
        }
      });
    ...
    // Change timer size
      $("#timer-size-input").change(function() {
        ...
        if (currentTimerSize >= 10 && currentTimerSize <= 500) {
          $("#timer-size-input").val(currentTimerSize + '%');
          $("#Timer").css('font-size',  20+(currentTimerSize-100)/10);
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User changed timer size to ${$(this).val()}.\n`);
        } else{
          currentTimerSize = 100;
          $("#timer-size-input").val(currentTimerSize + '%');
          $("#Timer").css('font-size',  20);
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User tried to change timer size to an invalid value.\n`);
        }
      });
    ...
    // Decrease img size
      $("#decrease-img-size").on("click", function() {
        ...
        if (currentImgHeight > 30)  {
          ...
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User decreased image size to ${$("#image-size-input").val()}.\n`);
        }
        else{
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User tried to decrease image size below minimum.\n`);
        }
      });
    ...
    // Increase img size
      $("#increase-img-size").on("click", function() {
        ...
        if (currentImgHeight < 600)  {
          ...
          $("#sec0-qimg").css("width", currentImgHeight/3 *4);
          $("#sec0-qimg").css("height", currentImgHeight);
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User increased image size to ${$("#image-size-input").val()}.\n`);
        } else{
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User tried to increase image size over maximum.\n`);
        }
      });
    ...
    // Change img size
      $("#image-size-input").change(function() {
        ...
        if(currentImgSize >= 10 && currentImgSize <= 200){
          ...
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User changed image size to ${$(this).val()}.\n`);
        } else{
          currentImgSize = 100;
          $("#image-size-input").val(currentImgSize + "%");
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User tried to change image size to an invalid value.\n`);
        }
    ...
    // Change font style
      $("#font-style-select").on("change", function() {
          ...
          const relativeTimestamp = currentTime - initialTime;
          const formatedTime = formatTime(relativeTimestamp);
          consoleLog.push(`[${formatedTime}], Pre-Section-2, User changed font style to ${$('#font-style-select option:selected').text()}.\n`);
      });
    ...
    // Change img position
      $("#img-pos-select").on("change", function(){
        ...
        const relativeTimestamp = currentTime - initialTime;
        const formatedTime = formatTime(relativeTimestamp);
        consoleLog.push(`[${formatedTime}], Pre-Section-2, User changed image position to ${$("#img-pos-select option:selected").text()}.\n`);
      });
    ...
    // Change bkg color
      $('#bkg-color-picker').on('change', function() {
        ...
        const relativeTimestamp = currentTime - initialTime;
        const formatedTime = formatTime(relativeTimestamp);
        consoleLog.push(`[${formatedTime}], Pre-Section-2, User changed background color to ${$(this).val()}.\n`);
      });
    ...
    // Change font color
     $('#font-color-picker').on('change', function() {
        ...
        consoleLog.push(`[${formatedTime}], Pre-Section-2, User changed font color to ${$(this).val()}.\n`);
      });
    ...
    // Change timer color
     $('#timer-color-picker').on('change', function() {
        ...
        const relativeTimestamp = currentTime - initialTime;
        const formatedTime = formatTime(relativeTimestamp);
        consoleLog.push(`[${formatedTime}], Pre-Section-2, User changed timer color to ${$(this).val()}.\n`);
      });
  ...
  $("#timer-style-btn").on('click', function() {
      ...
      consoleLog.push(`[${formatedTime}], Pre-Section-2, User changed timer style to ${textLog}.\n`);
    });
    ...
    // Reset
      $("#ui-reset-btn").on("click", function(){
        ...
        const relativeTimestamp = currentTime - initialTime;
        const formatedTime = formatTime(relativeTimestamp);
        consoleLog.push(`[${formatedTime}], Pre-Section-2, User reset UI to default.\n`);
      });
  
      $("#section-start-btn2").on("click", function(){
